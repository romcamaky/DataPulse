"""
DataPulse monthly career intelligence report: Supabase marts + profile → markdown file.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate monthly career intelligence markdown report (Supabase → docs/reports).",
    )
    parser.add_argument(
        "--user-id",
        type=str,
